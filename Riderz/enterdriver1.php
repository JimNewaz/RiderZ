<html>
  ...
  <head>
    <title> customer Signup | RIDERZ </title>
  </head>
  <?php session_start(); ?>
...
$admin_username = $_SESSION['login_client'];
$driver_availability = "yes";

$query = "INSERT into driver(driver_name,dl_number,driver_phone,driver_address,driver_gender,admin_username,driver_availability) VALUES('" . $driver_name . "','" . $dl_number . "','" . $driver_phone . "','" . $driver_address . "','" . $driver_gender ."','" . $admin_username ."','" . $driver_availability ."')";
