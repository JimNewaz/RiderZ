...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-main-collapse">
                    ...
                    <img src="assets/img/logo.png" style="padding:0px; margin-top:-25px;" alt="logo">
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white">RIDERZ</h1>
                            <p class="intro-text">
    ...
    <br>
        <section class="menu-content">
            ...
            <h6> AC Fare: <?php echo ("BDT" . $ac_price . "/km & BDT" . $ac_price_per_day . "/day"); ?></h6>
            
            <h6> Non-AC Fare: <?php echo ("BDT" . $non_ac_price . "/km & BDT" . $non_ac_price_per_day . "/day"); ?></h6>
          ...
          <div class="col-12">
            ...
            <form class="trip-form">
              <div class="row align-items-center mb-4">
                <div class="col-md-12">
                  <h3 class="m-0" style="text-align:center;">Begin your trip here</h3>
                </div>
                
              </div>
              <div class="row">
                <div class="form-group col-md-3">
                  <label for="cf-1">Your Location:</label>
                  <input type="text" id="cf-1" placeholder="Your pickup address" class="form-control">
                </div>
                <div class="form-group col-md-3">
                  <label for="cf-2">Your Destination:</label>
                  <input type="text" id="cf-2" placeholder="Your drop-off address" class="form-control">
                </div>
                <div class="form-group col-md-3">
                  <label for="cf-3">Trip Date:</label>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    ...
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +123456789<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: mail@gmail.com<br>
                </div>
                <p>Drop Your Details and Leave it on us We'll Revert</p>
