...
<?php
    ...
    $sql4 = "SELECT * FROM  cars c, admin cl, driver d, rentedcars rc WHERE c.car_id = '$car_id' AND d.driver_id = '$driver_id' AND cl.admin_username = d.admin_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center">We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                if($charge_type == "days"){
                ?>
                     <h4> <strong>Fare:</strong> BDT<?php echo $fare; ?>/day</h4>
                <?php } else {
                    ?>
                    <h4> <strong>Fare:</strong> BDT<?php echo $fare; ?>/km</h4>
                ...
                <br>
                <h4> <strong>Client Name:</strong>  <?php echo $admin_name; ?></h4>
                <br>
                <h4> <strong>Client Contact: </strong> <?php echo $admin_phone; ?></h4>
                <br>
            </div>
        </div>
